...
const OurService = () => {
    return (
        <div className='bg-secondary p-10'>
            <h2 className='text-white text-3xl text-center font-bold'>Our Services</h2>
            <p className='text-slate-300 text-center text-sm'>Enjoy fast, reliable parcel delivery with real-time tracking and zero hassle. From personal packages to business shipments — we deliver on time, every time.</p>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
                <div className='m-5 card bg-base-200 shadow-xl p-6 gap-3 items-center text-center'>
